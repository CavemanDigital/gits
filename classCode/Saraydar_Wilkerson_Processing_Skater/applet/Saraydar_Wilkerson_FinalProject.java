...
public class Saraydar_Wilkerson_FinalProject extends PApplet {
...
// by the Gator, walkingDude, or BikerDude
   public boolean intersect1(WalkingDude w) {
   ...
   public boolean intersect2 (Gator g) { 
  ...
  public boolean intersect3 (BikerDude b) {
...
class Timer {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#f0f0f0", "Saraydar_Wilkerson_FinalProject" });
  }
}
